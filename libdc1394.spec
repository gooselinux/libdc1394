...
Patch1: libdc1394-2.1.2-juju.patch
...
%changelog
* Wed May 19 2010 Jay Fenlason <fenlason@redhat.com> - 2.1.2-3.4
- Fix the install command for the example programs:
  grab_color_image grab_gray_image grab_partial_image ladybug grab_partial_pvn
  Resolves: rhbz593778

* Mon Apr 5 2010 Jay Fenlason <fenlason@redhat.com> - 2.1.2-3.3
- Fix the source url to point to the correct sourceforge url.
  Related: rhbz555835

* Mon Apr 5 2010 Jay Fenlason <fenlason@redhat.com> - 2.1.2-3.2
- Remove the bundled firewire-{cdev,constants}.h fires and add the -juju patch to build against
  the system firewire-cdev.h instead.
  Related: rhbz555835

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 2.1.2-3.1
- Rebuilt for RHEL 6
